...
- `company/workspace/state/last-action.md` — Exactly what was done during this IDE session.
- `company/workspace/state/current-task.md` — Updated status, blockers, next action.
- `company/workspace/state/task-history.md` — Add entry if a task was completed.
