...
- [ ] `company/workspace/state/last-action.md` — Update with last action, next expected action.
- [ ] `company/workspace/state/current-task.md` — Update status, blockers.
- [ ] If a task was completed: update `company/workspace/state/task-history.md`.
...
1. `company/workspace/state/last-action.md` — Exact last step taken.
2. `company/workspace/state/current-task.md` — What is being worked on.
3. `company/workspace/state/progress-snapshot.md` — Overall project status.
4. `company/workspace/state/task-history.md` — Completed work context.
...
- `company/handbook/mission.md` — Project purpose.
- `company/handbook/engineering-principles.md` — Technical standards.
- Relevant sections from `company/policies/` — Active constraints.
