...
### Step 3: Read relevant policies and handbook

Read the policies and handbook sections that apply to the current task. The new model does not have the previous model's context — it must be provided explicitly.
