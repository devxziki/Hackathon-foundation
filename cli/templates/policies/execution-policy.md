...
Define the mandatory execution lifecycle for all work performed within the Hackathon Foundation framework. Every task, regardless of size or department, must follow this lifecycle.
