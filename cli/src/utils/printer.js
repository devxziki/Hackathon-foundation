...
export function printBanner() {
  console.log(kleur.cyan().bold('\n  Foundation AI — Context Continuity for Any Project\n'));
}
...
export function printDetection(projectInfo, gitContext) {
  ...
  console.log(kleur.cyan('  │') + '  Foundation AI — Project Detected            ' + kleur.cyan('│'));
...
export function printSuccess(created, skipped, missingTemplates, cwd) {
  ...
  console.log(kleur.cyan('         company/workspace/state/last-action.md'));
  console.log(kleur.cyan('         company/workspace/state/current-task.md'));
  console.log(kleur.cyan('         company/workspace/state/progress-snapshot.md'));
  console.log();
  console.log('    2. Start your AI session:');
  console.log(kleur.cyan('         bash scripts/start-session.sh'));
  console.log();
...
export function printStatus(state) {
  ...
  console.log();
  console.log(`  ${kleur.green('→')} To resume: ${kleur.cyan('bash scripts/start-session.sh')}`);
  console.log();
}
